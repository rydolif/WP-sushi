...
if ( $product->is_in_stock() ) : ?>
	...
	<form class="goods-block__order cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
