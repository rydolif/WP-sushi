...
<div class="woocommerce-order">
	...
	<?php if ( $order ) : ?>
		...
		<?php else : ?>
			...
			<h4 class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received">
				<b>
		...
		<b class=""><?php do_action( 'woocommerce_thankyou_' . $order->get_payment_method(), $order->get_id() ); ?></b>
		<br>
	...
	<div class="btn__wrap"><a href="<?php echo get_home_url(); ?>" class="btn btn--thanks">Вернутся в магазин</a></div>
